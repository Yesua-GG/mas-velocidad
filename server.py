...
POSSIBLE_CRED_PATHS = [
    ...
    '/root/Asistente-web/firebase-auth.json',  # Ruta específica vista en logs
    './firebase-auth.json',
    '../firebase-auth.json'
]
...
def config_ui():
    ...
    VERSION_MAP = {
        'v1': {'name': 'Original', 'phone': '573142999526', 'logo': 'https://vidcache.net:8161/static/85da964fa796b810f504b3cf81b89b36be6cb4fb/indrive automatico.jpeg', 'show_distributor': True, 'title': 'InDrive Automático'},
